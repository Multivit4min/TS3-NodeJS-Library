...
### teamSpeak3.serverGroupAddClient(cldbid, sgid) ⇒ <code>Promise</code>
...
### teamSpeak3.serverGroupDelClient(cldbid, sgid) ⇒ <code>Promise</code>
...
### teamSpeak3.ftInitUpload(transfer) ⇒ <code>Promise</code>
...
### teamSpeak3.ftInitDownload(transfer) ⇒ <code>Promise</code>
...
| --- | --- | --- |
| The | <code>mixed</code> | Error Object |
...
| Name | Type | Description |
| --- | --- | --- |
| client | <code>class</code> | The Client which joined the Server |
...
* [TeamSpeak3](#TeamSpeak3)
    ...
    * [.getChannelByID(cid)](#TeamSpeak3+getChannelByID) ⇒ <code>Promise.&lt;TeamSpeakChannel&gt;</code>
    * [.getChannelByName(name)](#TeamSpeak3+getChannelByName) ⇒ <code>Promise.&lt;TeamSpeakChannel&gt;</code>
    * [.getClientByID(clid)](#TeamSpeak3+getClientByID) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
    * [.getClientByDBID(cldbid)](#TeamSpeak3+getClientByDBID) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
    * [.getClientByUID(uid)](#TeamSpeak3+getClientByUID) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
    * [.getClientByName(name)](#TeamSpeak3+getClientByName) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
...
### teamSpeak3.getChannelByID(cid) ⇒ <code>Promise.&lt;TeamSpeakChannel&gt;</code>
Retrieves a Single Channel by the given Channel ID

**Kind**: instance method of [<code>TeamSpeak3</code>](#TeamSpeak3)  
**Returns**: <code>Promise.&lt;TeamSpeakChannel&gt;</code> - Promise object which returns the Channel Object or undefined if not found  
**Async**:   
**Version**: 1.0  
...
### teamSpeak3.getChannelByName(name) ⇒ <code>Promise.&lt;TeamSpeakChannel&gt;</code>
Retrieves a Single Channel by the given Channel Name
...
### teamSpeak3.getClientByID(clid) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
Retrieves a Single Client by the given Client ID

**Kind**: instance method of [<code>TeamSpeak3</code>](#TeamSpeak3)  
**Returns**: <code>Promise.&lt;TeamSpeakClient&gt;</code> - Promise object which returns the Client or undefined if not found  
**Async**:   
**Version**: 1.0  
...
### teamSpeak3.getClientByDBID(cldbid) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
Retrieves a Single Client by the given Client Database ID
...
### teamSpeak3.getClientByUID(uid) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
Retrieves a Single Client by the given Client Unique Identifier
...
### teamSpeak3.getClientByName(name) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
Retrieves a Single Client by the given Client Unique Identifier
