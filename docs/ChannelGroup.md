...
* [TeamSpeakChannelGroup](#TeamSpeakChannelGroup) ⇐ <code>Abstract</code>
    ...
    * [.clientList([cid], [cldbid])](#TeamSpeakChannelGroup+clientList) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
...
### teamSpeakChannelGroup.clientList([cid], [cldbid]) ⇒ <code>Promise.&lt;TeamSpeakClient&gt;</code>
Displays the IDs of all clients currently residing in the channel group.
